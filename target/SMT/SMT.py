...
def clean_logic(code):
    ...
    clean_code = "\n".join([x for x in clean_code.splitlines() if not x.startswith("(set-option :")])
    clean_code = "\n".join([x for x in clean_code.splitlines() if not x.startswith("(get-proof)")])
    return clean_code
    ...
    def validate_individual(self, filename) -> (FResult, str):
        ...
        try:
            cvc_exit_code = subprocess.run(
                    "cvc5 -m -i -q --check-models --lang smt2 temp{}.smt2".format(self.CURRENT_TIME),
        ...
        if (z3_sat != "" and cvc5_sat != "") and z3_sat != cvc5_sat:
            ...
            return FResult.ERROR, "Different SAT Results. Z3: {} CVC5: {}\nZ3:{}\nCVC5:{}".format(z3_sat, cvc5_sat,
                                                                                                  z3_exit_code.stdout,
        ...
        if z3_exit_code.returncode != 0 and cvc_exit_code.returncode != 0:
            return FResult.FAILURE, "Z3:\n{}\nCVC5:\n{}".format(z3_exit_code.stdout+z3_exit_code.stderr,
        ...
        if z3_exit_code.returncode != 0:
            if _check_error(cvc_exit_code.stdout):
                ...
                return FResult.ERROR, "CVC5 is fine:\n{}\n but Z3 outputs:\n{}"\
                    .format(cvc_exit_code.stdout+cvc_exit_code.stderr,
                            cvc_exit_code.stdout+cvc_exit_code.stderr)
